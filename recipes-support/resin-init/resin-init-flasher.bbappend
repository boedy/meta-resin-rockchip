...
INTERNAL_DEVICE_KERNEL_marsboard-rk3066 = "mmcblk1"

# the name of the bootloader config file to be written to internal media
INTERNAL_DEVICE_BOOTLOADER_CONFIG_marsboard-rk3066 = "uEnv.txt_internal"
...
INTERNAL_DEVICE_BOOTLOADER_CONFIG_PATH_marsboard-rk3066 = "/uEnv.txt"
